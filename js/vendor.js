...
//   if ($('#modal-tel-input') || $('#feedback-tel-input')) {
...
// const popupOverlayElement = document.querySelector('.modal-overlay');
// const openModalButton = document.querySelector('.header__recall-link')
...
// const modalFocusTrap = focusTrap.createFocusTrap('.modal'); // инициализируем плагин Focuc Trap для модального окна
...
// openModalButton.addEventListener('keydown', onEnterOpener);
